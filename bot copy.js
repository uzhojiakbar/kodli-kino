        ...
        if (isAdmin) {
          ...
          if (adminIdToRemove && adminIdToRemove.match(/^\d+$/)) {
            try {
              ...
              bot.sendMessage(chatId, "Xatolik yuz berdi, admin o'chirilmadi.");
              console.error(err);
            }
          } else {
            bot.sendMessage(chatId, "Iltimos, to'g'ri admin ID kiriting.");
          ...
          try {
            ...
            if (botAdminThisChannel.status === "administrator") {
              ...
              try {
                ...
                bot.sendMessage(chatId, "Xatolik yuz berdi, Kanal qoshilmadi.");
                console.error(err);
              }
            } else {
            ...
            try {
              if (type === "broadcast_normal") {
                ...
                if (broadcastMsg.photo) {
                  ...
                  await bot.sendAudio(user.userId, broadcastMsg.audio.file_id, {
                    caption: broadcastMsg.caption || "",
                    parse_mode: "HTML",
                  });
                } else if (broadcastMsg.document) {
                  ...
                  await bot.sendMessage(user.userId, broadcastMsg.text || "", {
                    parse_mode: "HTML",
                  });
                }
              } else if (type === "broadcast_forward") {
